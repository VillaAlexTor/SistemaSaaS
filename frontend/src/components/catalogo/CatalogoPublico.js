    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#1a1a1a' }}>
          ...
          >
            ...
            <div>
              ...
              <p style={{ margin: 0, color: '#aaa', fontSize: '13px' }}>
                Explora nuestras microempresas asociadas
              </p>
            </div>
          </div>
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '30px' }}>
        ...
        <div style={{
          ...
          background: 'linear-gradient(135deg, rgba(255,152,0,0.1) 0%, rgba(45,45,45,1) 100%)',
          textAlign: 'center'
        }}>
          <h2 style={{ margin: '0 0 10px 0', color: '#ff9800', fontSize: '28px' }}>
            ✨ Descubre Microempresas Locales
          </h2>
          <p style={{ margin: 0, color: '#aaa', fontSize: '16px' }}>
            Explora productos y servicios de emprendedores de tu comunidad. 
            <strong style={{ color: '#ff9800' }}> Crea una cuenta</strong> para guardar tus favoritos y realizar compras.
          </p>
        </div>
            ...
            >
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  padding: '6px 18px',
                  backgroundColor: empresa.plan === 'premium' ? '#000' : 'rgba(255,255,255,0.3)',
                  borderRadius: '20px',
                  color: '#fff',
                  fontSize: '11px',
                  fontWeight: 'bold',
                  backdropFilter: 'blur(10px)',
                  border: empresa.plan === 'premium' ? '2px solid #fff' : 'none'
                }}>
              ...
              <div style={{ padding: '25px' }}>
                <h3 style={{ margin: '0 0 12px 0', color: '#fff', fontSize: '22px', fontWeight: '700' }}>
                  {empresa.nombre}
                </h3>
        ...
        {empresasFiltradas.length === 0 && (
          <div style={{
            ...
            <h3 style={{ margin: 0, color: '#fff', fontSize: '28px', marginBottom: '15px' }}>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          <h3 style={{ margin: '0 0 15px 0', color: '#ff9800', fontSize: '24px' }}>
            ¿Tienes una microempresa?
          </h3>
          <p style={{ margin: '0 0 25px 0', color: '#aaa', fontSize: '16px' }}>
